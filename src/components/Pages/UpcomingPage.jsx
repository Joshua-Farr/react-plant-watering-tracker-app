...
export default function UpcomingPage() {
  return (
    <>
      ...
      <div className="upcoming-reminder-card">
        <div>
          <h3 className="time-left-until-action">In 13 days</h3>
          <h4 className="tasks-remaining">1 task</h4>
        </div>
        <div className="upcoming-plant-information">
          <div className="icon-circle">
          ...
          <div className="reminder-info-text">
            <h3>Orchid</h3>
            <h4 className="reminder-info-location">Living Room</h4>
          </div>
          <div className="task-bubble">
            <WaterDropRoundedIcon size="large" />
          </div>
      ...
      <div className="upcoming-reminder-card">
        <div>
          <h3 className="time-left-until-action">In 21 days</h3>
          <h4 className="tasks-remaining">3 task</h4>
        </div>
        <div className="upcoming-plant-information">
          <div className="icon-circle">
            <img src="" alt="" />
          ...
          <div className="reminder-info-text">
            <h3>Succulent</h3>
            <h4 className="reminder-info-location">Kitchen</h4>
          </div>
          <div className="task-bubble">
            <WaterDropRoundedIcon size="large" />
          </div>
